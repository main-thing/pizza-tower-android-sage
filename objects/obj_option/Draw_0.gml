...
if (optionselected == 3)
    draw_text_colour(480, 450, "PANIC SHADER", c_white, c_white, c_white, c_white, 1)
else
    draw_text_colour(480, 450, "PANIC SHADER", c_white, c_white, c_white, c_white, 0.5)
if (optionsaved_shader)
    draw_text_colour(380, 500, "ON", c_white, c_white, c_white, c_white, 1)
else
    draw_text_colour(380, 500, "ON", c_white, c_white, c_white, c_white, 0.5)
if (!optionsaved_shader)
    draw_text_colour(580, 500, "OFF", c_white, c_white, c_white, c_white, 1)
else
    draw_text_colour(580, 500, "OFF", c_white, c_white, c_white, c_white, 0.5)
